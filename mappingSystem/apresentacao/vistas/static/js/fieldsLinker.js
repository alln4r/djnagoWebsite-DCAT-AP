...
//_______________________Add by othmane 25/04/2022________________________________

                $(this).find(".FL-main .FL-left li").on("click", function (e) {
...
//_______________________End Add by othmane 25/04/2022________________________________
                ...
                $(this).find(".FL-main .FL-right li").on("mouseup", function (e) {
                    ...
                    if (move == null) { // no drag 
                        ...
                        $(this).removeData('val');// we erase an existing link if any Add by othmane 05/05/2022
                        $(this).removeAttr("data-val");// we erase an existing link if any Add by othmane 05/05/2022
                        $(this).children().css('color', '#aaaaaa');// we erase an existing link if any Add by othmane 05/05/2022
